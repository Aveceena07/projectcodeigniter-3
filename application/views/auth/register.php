    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form action="<?php echo base_url(); ?>Auth/aksi_register" method="post">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Register</button></div><a href="./auth/login" class="already">You already have an account? Login here.</a>
              </form>
            </div>
          </div>
        </body>
